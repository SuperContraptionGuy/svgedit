...
const htmlWhiteList_ = {
  ...
  // 'contenteditable' is an attribute generated by Squire
  div: ['xmlns', 'contenteditable'],
  DIV: ['xmlns', 'contenteditable'],
  p: [],
  P: [],
  br: [],
...
const svgWhiteList_ = {
  ...
  foreignObject: ['shape', 'font-size', 'height', 'opacity', 'requiredFeatures', 'width', 'x', 'y'],
      ...
      if (attrNsURI !== allowedAttrsNS[attrLocalName] && attrNsURI !== NS.XMLNS &&
       !(attrNsURI === NS.XMLNS && REVERSE_NS[attr.value])) {
        ...
        if (attrName.startsWith('se:') || attrName.startsWith('oi:') || attrName.startsWith('data-')) {
          ...
          // information about what was removed for debugging purposes
          console.warn(node)
